...
class CustomScanWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.label_scan_frequency = LabelWidgetHelper("Frequency", LABEL_WIDTH, LABEL_HEIGHT)
        self.label_samples_orientation = LabelWidgetHelper("Samples", LABEL_WIDTH, LABEL_HEIGHT)
        
        """sliders"""
        self.slider_azimuth_min = SliderWidgetHelper(SLIDER_WIDTH, SLIDER_HEIGHT, AZIMUTH_MIN_LOW, AZIMUTH_MIN_HIGH, AZIMUTH_STEP)
        self.slider_azimuth_max = SliderWidgetHelper(SLIDER_WIDTH, SLIDER_HEIGHT, AZIMUTH_MAX_LOW, AZIMUTH_MAX_HIGH, AZIMUTH_STEP)
        self.slider_elevation_min = SliderWidgetHelper(SLIDER_WIDTH, SLIDER_HEIGHT, ELEVATE_MIN_LOW, ELEVATE_MIN_HIGH, ELEVATE_STEP)
        self.slider_elevation_max = SliderWidgetHelper(SLIDER_WIDTH, SLIDER_HEIGHT, ELEVATE_MAX_LOW, ELEVATE_MAX_HIGH, ELEVATE_STEP)
        self.slider_step_change = SliderWidgetHelper(SLIDER_WIDTH, SLIDER_HEIGHT, STEP_CHANGE_LOW, STEP_CHANGE_HIGH, STEP_CHANGE_STEP)
        self.slider_scan_frequency = SliderWidgetHelper(SLIDER_WIDTH, SLIDER_HEIGHT, SAMPLE_FREQUENCY_LOW, SAMPLE_FREQUENCY_HIGH, SAMPLE_FREQUENCY_STEP)
        self.slider_samples_orientation = SliderWidgetHelper(SLIDER_WIDTH, SLIDER_HEIGHT, SAMPLES_PER_LOW, SAMPLES_PER_HIGH, SAMPLES_PER_STEP)
        
        """ LCDs """
        self.lcd_azimuth_min = LCDWidgetHelper("lcd_azi_min", False, LCD_WIDTH, LCD_HEIGHT)
        self.lcd_azimuth_max = LCDWidgetHelper("lcd_azi_max", False, LCD_WIDTH, LCD_HEIGHT)
        self.lcd_elevation_min = LCDWidgetHelper("lcd_ele_min", False, LCD_WIDTH, LCD_HEIGHT)
        self.lcd_elevation_max = LCDWidgetHelper("lcd_ele_max", False, LCD_WIDTH, LCD_HEIGHT)
        self.lcd_step_change = LCDWidgetHelper("lcd_step_change", False, LCD_WIDTH, LCD_HEIGHT)
        self.lcd_scan_frequency = LCDWidgetHelper("lcd_scan_freq", False, LCD_WIDTH, LCD_HEIGHT)
        self.lcd_samples_orientation = LCDWidgetHelper("lcd_samp_ori", False, LCD_WIDTH, LCD_HEIGHT)
        ...
        GenericLayoutHelper(self.vertical_layout_one, [self.GBox_Azimuth, self.GBox_Elevation, self.GBox_StepChange, self.GBox_ScanFrequency, self.GBox_SamplesPerOrientaiton])
